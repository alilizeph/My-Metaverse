 ...
 */
final class Version20240424130553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE video_game (id INT AUTO_INCREMENT NOT NULL, platform_id INT DEFAULT NULL, likes_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(1255) NOT NULL, advice VARCHAR(1255) NOT NULL, img_box_file_name VARCHAR(255) DEFAULT NULL, img_box_size INT DEFAULT NULL, img_theme_file_name VARCHAR(255) DEFAULT NULL, img_theme_size INT DEFAULT NULL, grade INT NOT NULL, release_date DATETIME NOT NULL, disponibility TINYINT(1) NOT NULL, average_price DOUBLE PRECISION NOT NULL, link VARCHAR(2500) NOT NULL, average_users_grade INT NOT NULL, INDEX IDX_24BC6C50FFE6496F (platform_id), UNIQUE INDEX UNIQ_24BC6C502F23775F (likes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
