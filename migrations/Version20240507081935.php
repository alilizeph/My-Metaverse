 ...
 */
final class Version20240507081935 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, private_fields_disponibility TINYINT(1) DEFAULT 0 NOT NULL, email VARCHAR(255) NOT NULL, gender VARCHAR(255) NOT NULL, birthday DATETIME NOT NULL, nb_likes INT NOT NULL, nb_comments INT NOT NULL, avatar_new_file_name VARCHAR(255) DEFAULT NULL, avatar_file_size INT DEFAULT NULL, presentation VARCHAR(1555) NOT NULL, is_admin TINYINT(1) DEFAULT 0 NOT NULL, is_regestered TINYINT(1) DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE video_game (id INT AUTO_INCREMENT NOT NULL, platform_id INT DEFAULT NULL, likes_id INT DEFAULT NULL, title_review VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(1255) NOT NULL, advice VARCHAR(1255) NOT NULL, img_box_file_name VARCHAR(255) DEFAULT NULL, img_box_size INT DEFAULT NULL, img_theme_file_name VARCHAR(255) DEFAULT NULL, img_theme_size INT DEFAULT NULL, graphics_grade INT NOT NULL, gameplay_grade INT NOT NULL, storyline_grade INT NOT NULL, execution_grade INT NOT NULL, grade INT NOT NULL, release_date DATETIME NOT NULL, disponibility TINYINT(1) NOT NULL, average_price DOUBLE PRECISION NOT NULL, link VARCHAR(2500) NOT NULL, average_users_grade INT NOT NULL, INDEX IDX_24BC6C50FFE6496F (platform_id), UNIQUE INDEX UNIQ_24BC6C502F23775F (likes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
