...
return [
    ...
    'app_admin_edit' => [['id'], ['_controller' => 'App\\Controller\\AdminController::adminEditVideoGame'], ['id' => '[1-999]\\d*'], [['variable', '/', '[1-999]\\d*', 'id', true], ['text', '/admin/edit']], [], [], []],
    'app_admin_remove' => [['id'], ['_controller' => 'App\\Controller\\AdminController::adminRemoveVideoGame'], ['id' => '[1-999]\\d*'], [['variable', '/', '[1-999]\\d*', 'id', true], ['text', '/admin/remove']], [], [], []],
    ...
    'App\Controller\AdminController::adminEditVideoGame' => [['id'], ['_controller' => 'App\\Controller\\AdminController::adminEditVideoGame'], ['id' => '[1-999]\\d*'], [['variable', '/', '[1-999]\\d*', 'id', true], ['text', '/admin/edit']], [], [], []],
    'App\Controller\AdminController::adminRemoveVideoGame' => [['id'], ['_controller' => 'App\\Controller\\AdminController::adminRemoveVideoGame'], ['id' => '[1-999]\\d*'], [['variable', '/', '[1-999]\\d*', 'id', true], ['text', '/admin/remove']], [], [], []],
