 ...
 */
class getVichUploader_Listener_Clean_VideogameThemesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.videogame_themes' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.videogame_themes'])) {
            return $container->privates['vich_uploader.listener.clean.videogame_themes'];
        }

        return $container->privates['vich_uploader.listener.clean.videogame_themes'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('videogame_themes', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
