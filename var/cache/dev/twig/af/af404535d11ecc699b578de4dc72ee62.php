...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        yield " ";
        yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 18, $this->source); })()), "surname", [], "any", false, false, false, 18), "html", null, true);
        yield "</h4>
                </section>
            </section>
            <section class=\"profile-presentation hide-2\">
                <h5 class=\" hide-3\">Présentation </h5>
                ";
        // line 23
        if (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 23, $this->source); })()), "user", [], "any", false, false, false, 23), "presentation", [], "any", false, false, false, 23) != null) && (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 23, $this->source); })()), "user", [], "any", false, false, false, 23), "presentation", [], "any", false, false, false, 23) != ""))) {
            // line 24
            yield "                    <p class=\"profile-presentation-content hide-3\">";
            yield Twig\Extension\EscaperExtension::escape($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 24, $this->source); })()), "presentation", [], "any", false, false, false, 24), "html", null, true);
            yield "</p>
                ";
        }
        // line 26
        yield "            </section>
            <section>
                <a href=\"";
        // line 28
        yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("update_user", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 28, $this->source); })()), "id", [], "any", false, false, false, 28)]), "html", null, true);
        yield "\">
...
";
    ...
    {
        return array (  140 => 28,  136 => 26,  130 => 24,  128 => 23,  118 => 18,  114 => 17,  110 => 15,  102 => 13,  100 => 12,  94 => 8,  84 => 7,  70 => 4,  60 => 3,  37 => 1,);
    }
    ...
    <main>
        <article class=\"profile hide\">
            <section class=\"profile-head hide-2\">
                ...
                <h4 *ngIf=\"user\">{{ user.firstName }} {{ user.surname }}</h4>
                </section>
            </section>
            <section class=\"profile-presentation hide-2\">
                <h5 class=\" hide-3\">Présentation </h5>
