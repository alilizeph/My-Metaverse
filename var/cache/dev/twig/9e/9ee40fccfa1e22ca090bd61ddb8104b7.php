...
class __TwigTemplate_feaa5950264dfc85ca90aec18ff22b9e extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        ...
        if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 13, $this->source); })())) {
            // line 14
            yield "\t\t\t\t\t<section class=\"alert alert-danger\">
\t\t\t\t\t\t";
            // line 15
...
\t\t\t\t\t<input type=\"text\" id=\"username\" name=\"_username\" value=\"";
        // line 20
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["last_username"]) || array_key_exists("last_username", $context) ? $context["last_username"] : (function () { throw new RuntimeError('Variable "last_username" does not exist.', 20, $this->source); })()), "html", null, true);
        yield "\">
\t\t\t\t</section>
...
";
    ...
    {
        return array (  149 => 26,  140 => 20,  136 => 18,  130 => 15,  127 => 14,  125 => 13,  121 => 12,  116 => 9,  106 => 8,  92 => 6,  82 => 5,  61 => 3,  38 => 1,);
    }
