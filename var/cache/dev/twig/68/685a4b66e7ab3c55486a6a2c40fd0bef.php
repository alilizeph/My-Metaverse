...
class __TwigTemplate_050fdf7a6310e1783f4e8507ca44b022 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 9
        echo "\t<main>
\t\t<article class=\"signin-card hide\">
\t\t\t<h3 class=\" hide-2\">Connexion</h3>
...
\t\t\t\t\t<input type=\"password\" id=\"pwd\" name=\"_password\">
\t\t\t\t</div>
\t\t\t\t<input type=\"hidden\" name=\"_csrf_token\" value=\"";
        // line 24
        echo twig_escape_filter($this->env, $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken("authenticate"), "html", null, true);
        echo "\">
\t\t\t\t<button type=\"submit hide-3\">Se connecter</button>
\t\t\t</form>
\t\t</article>
\t</main>
";
    ...
    {
        return array (  143 => 24,  134 => 18,  130 => 16,  124 => 14,  122 => 13,  118 => 12,  113 => 9,  103 => 8,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
\t\t<article class=\"signin-card hide\">
\t\t\t<h3 class=\" hide-2\">Connexion</h3>
\t\t\t<form method=\"post\" action=\"{{ path('app_login_check') }}\" class=\" hide-2\">
\t\t\t\t{% if error %}
...
\t</main>
{% endblock %}
", "security/login.html.twig", "C:\\Users\\robocop\\Desktop\\REVISIONS WEB\\FIRST PROJECTS\\MyMetaverseV2.0\\MyMetaverse\\templates\\security\\login.html.twig");
    }
}
