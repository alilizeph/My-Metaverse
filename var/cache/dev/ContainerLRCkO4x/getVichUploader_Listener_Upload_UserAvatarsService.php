 ...
 */
class getVichUploader_Listener_Upload_UserAvatarsService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.upload.user_avatars' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.upload.user_avatars'])) {
            return $container->privates['vich_uploader.listener.upload.user_avatars'];
        }

        return $container->privates['vich_uploader.listener.upload.user_avatars'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('user_avatars', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
