...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.user_avatars' => 'getSmartUniqueNamer_UserAvatarsService',
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.videogame_box' => 'getSmartUniqueNamer_VideogameBoxService',
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.videogame_themes' => 'getSmartUniqueNamer_VideogameThemesService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('nijF0NNMu3', 0, ($container->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UknBMPt2sh', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yOcEgSrcLN', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\VideoGameRepository' => ['privates', 'App\\Repository\\VideoGameRepository', 'getVideoGameRepositoryService', true],
        ], [
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AdminController', 'App\\Controller\\DefaultController', 'App\\Controller\\SecurityController', 'App\\Controller\\UserController', 'App\\Controller\\VideoGameController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mY93FpYyK2', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('A8PCTJ6kom', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0MuEXwJOkW', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YJdrzYFllf', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WcZ4KwvVIv', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        return $container->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'vich_uploader.listener.clean.user_avatars' => ['privates', 'vich_uploader.listener.clean.user_avatars', 'getVichUploader_Listener_Clean_UserAvatarsService', true],
            'vich_uploader.listener.clean.videogame_box' => ['privates', 'vich_uploader.listener.clean.videogame_box', 'getVichUploader_Listener_Clean_VideogameBoxService', true],
            'vich_uploader.listener.clean.videogame_themes' => ['privates', 'vich_uploader.listener.clean.videogame_themes', 'getVichUploader_Listener_Clean_VideogameThemesService', true],
            'vich_uploader.listener.remove.user_avatars' => ['privates', 'vich_uploader.listener.remove.user_avatars', 'getVichUploader_Listener_Remove_UserAvatarsService', true],
            'vich_uploader.listener.remove.videogame_box' => ['privates', 'vich_uploader.listener.remove.videogame_box', 'getVichUploader_Listener_Remove_VideogameBoxService', true],
            'vich_uploader.listener.remove.videogame_themes' => ['privates', 'vich_uploader.listener.remove.videogame_themes', 'getVichUploader_Listener_Remove_VideogameThemesService', true],
            'vich_uploader.listener.upload.user_avatars' => ['privates', 'vich_uploader.listener.upload.user_avatars', 'getVichUploader_Listener_Upload_UserAvatarsService', true],
            'vich_uploader.listener.upload.videogame_box' => ['privates', 'vich_uploader.listener.upload.videogame_box', 'getVichUploader_Listener_Upload_VideogameBoxService', true],
            'vich_uploader.listener.upload.videogame_themes' => ['privates', 'vich_uploader.listener.upload.videogame_themes', 'getVichUploader_Listener_Upload_VideogameThemesService', true],
        ], [
            ...
            'vich_uploader.listener.clean.user_avatars' => '?',
            'vich_uploader.listener.clean.videogame_box' => '?',
            'vich_uploader.listener.clean.videogame_themes' => '?',
            'vich_uploader.listener.remove.user_avatars' => '?',
            'vich_uploader.listener.remove.videogame_box' => '?',
            'vich_uploader.listener.remove.videogame_themes' => '?',
            'vich_uploader.listener.upload.user_avatars' => '?',
            'vich_uploader.listener.upload.videogame_box' => '?',
            'vich_uploader.listener.upload.videogame_themes' => '?',
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.user_avatars'], [['preUpdate'], 'vich_uploader.listener.clean.videogame_themes'], [['preUpdate'], 'vich_uploader.listener.clean.videogame_box'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['preRemove'], 'vich_uploader.listener.remove.user_avatars'], [['postFlush'], 'vich_uploader.listener.remove.user_avatars'], [['prePersist'], 'vich_uploader.listener.upload.user_avatars'], [['preUpdate'], 'vich_uploader.listener.upload.user_avatars'], [['preRemove'], 'vich_uploader.listener.remove.videogame_themes'], [['postFlush'], 'vich_uploader.listener.remove.videogame_themes'], [['prePersist'], 'vich_uploader.listener.upload.videogame_themes'], [['preUpdate'], 'vich_uploader.listener.upload.videogame_themes'], [['preRemove'], 'vich_uploader.listener.remove.videogame_box'], [['postFlush'], 'vich_uploader.listener.remove.videogame_box'], [['prePersist'], 'vich_uploader.listener.upload.videogame_box'], [['preUpdate'], 'vich_uploader.listener.upload.videogame_box']]);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'avatar_directory' => (\dirname(__DIR__, 4).'/public/uploads/avatar'),
            'box_directory' => (\dirname(__DIR__, 4).'/public/uploads/box'),
            'theme_directory' => (\dirname(__DIR__, 4).'/public/uploads/themes'),
            ...
            'vich_uploader.mappings' => [
                'user_avatars' => [
                    ...
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/uploads/avatar'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.user_avatars',
                        'options' => [
                ...
                'videogame_themes' => [
                    ...
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/uploads/themes'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.videogame_themes',
                        'options' => [
                ...
                'videogame_box' => [
                    'uri_prefix' => '/uploads/box',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/uploads/box'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.videogame_box',
                        'options' => [
